...
public class StringExtensionsTests
{
    ...
    [TestCase("", BracketTypes.None, ExpectedResult = true)]
    [TestCase("{{   {", BracketTypes.None, ExpectedResult = false)]
    [TestCase("[", BracketTypes.None, ExpectedResult = false)]
    [TestCase("{432   34}Test [Test][Test Test)", BracketTypes.None, ExpectedResult = false)]
    ...
    [TestCase("([([   {{ }}  ])])", BracketTypes.None, ExpectedResult = true)]
    [TestCase("{abc  ([b ]a)}", BracketTypes.None, ExpectedResult = true)]
    [TestCase("Test Test Test", BracketTypes.None, ExpectedResult = true)]
    [TestCase("{abc   ([a{sas}b]a)}", BracketTypes.None, ExpectedResult = true)]
    [TestCase("ab  c([b] a)}", BracketTypes.None, ExpectedResult = false)]
    ...
    [TestCase("{abc(   [a{s  {as}b]a)}   }", BracketTypes.None, ExpectedResult = false)]
    ...
    [TestCase("{", BracketTypes.None, ExpectedResult = false)]
    [TestCase("}", BracketTypes.None, ExpectedResult = false)]
    [TestCase("}Test", BracketTypes.None, ExpectedResult = false)]
    [TestCase("} ( )Test {", BracketTypes.None, ExpectedResult = false)]
